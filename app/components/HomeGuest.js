...
function HomeGuest() {
  ...
  function ourReducer(draft, action) {
    switch (action.type) {
      ...
      case "usernameUniqueResults":
        ...
        } else draft.username.isUnique = true
        return
      ...
      case "emailAfterDelay":
        ...
        if (!draft.email.hasErrors && !action.noRequest) draft.email.checkCount++
        return
  ...
  useEffect(() => {
    if (state.submitCount) {
      ...
      async function fetchResults() {
        try {
          const resp = await Axios.post("/register", { username: state.username.value, email: state.email.value, password: state.password.value }, { cancelToken: ourReq.token })
        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <CSSTransition in={state.username.hasErrors} timeout={330} classNames="liveValMessage" unmountOnExit>
            ...
            <div className="form-group">
              ...
              <CSSTransition in={state.email.hasErrors} timeout={330} classNames="liveValMessage" unmountOnExit>
            ...
            <div className="form-group">
              ...
              <CSSTransition in={state.password.hasErrors} timeout={330} classNames="liveValMessage" unmountOnExit>
